...
<body>
                    ...
                    <div class="col-lg-9">
                        <div class="product-detail accordion-detail">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-2.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-1.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-3.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-4.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-5.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-6.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/evara/imgs/shop/product-16-7.jpg" alt="product image">
                                            </figure>
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="/evara/imgs/shop/thumbnail-3.jpg" alt="product image"></div>
                                            <div><img src="/evara/imgs/shop/thumbnail-4.jpg" alt="product image"></div>
                                            <div><img src="/evara/imgs/shop/thumbnail-5.jpg" alt="product image"></div>
                                            <div><img src="/evara/imgs/shop/thumbnail-6.jpg" alt="product image"></div>
                                            <div><img src="/evara/imgs/shop/thumbnail-7.jpg" alt="product image"></div>
                                            <div><img src="/evara/imgs/shop/thumbnail-8.jpg" alt="product image"></div>
                                            <div><img src="/evara/imgs/shop/thumbnail-9.jpg" alt="product image"></div>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-facebook"><a href="#"><img src="/evara/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                            <li class="social-twitter"> <a href="#"><img src="/evara/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                            <li class="social-instagram"><a href="#"><img src="/evara/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                            <li class="social-linkedin"><a href="#"><img src="/evara/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="comment-list">
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="/evara/imgs/page/avatar-6.jpg" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="/evara/imgs/page/avatar-7.jpg" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="/evara/imgs/page/avatar-8.jpg" alt="">
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    ...
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view" class="action-btn small hover-up" tabindex="0"><i class="fi-rs-search"></i></a>
                            ...
                            <div class="banner-img banner-big wow fadeIn f-none animated mt-50">
                                <img class="border-radius-10" src="/evara/imgs/banner/banner-4.png" alt="">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="/evara/imgs/shop/thumbnail-3.jpg" alt="#">
                                </div>
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="/evara/imgs/shop/thumbnail-4.jpg" alt="#">
                                </div>
                                <div class="content pt-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="/evara/imgs/shop/thumbnail-5.jpg" alt="#">
                                </div>
                                <div class="content pt-10">
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            <img src="/evara/imgs/banner/banner-11.jpg" alt="">
                            <div class="banner-text">
    ...
    <script src="/evara/js/plugins/jquery.theia.sticky.js"></script>
    <script src="/evara/js/plugins/jquery.elevatezoom.js"></script>
    <!-- Template  JS -->
    <script src="/evara/js/shop.js"></script>
</body>
