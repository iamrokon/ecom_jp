                    ...
                    <div class="col-lg-9">
                        <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                            ...
                            <figure class="single-thumbnail">
                                <img src="{{asset('public/UserPanel/imgs/blog/blog-10.jpg')}}" alt="">
                            </figure>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget_categories mb-40">
                                ...
                                <div class="post-block-list post-module-1 post-module-5">
                                    <ul>
                                        ...
                                        <li class="cat-item cat-item-2"><a href="blog-category-list.html">{{$categorie->zokusei}}</a> (3)</li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                                ...
                                <div class="row">
                                    <div class="col-12 sm-grid-content mb-30">
                                        <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                            <a href="blog-post-fullwidth.html">
                                                <img src="{{asset('public/UserPanel/imgs/blog/blog-1.jpg')}}" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                            <a href="blog-post-fullwidth.html">
                                                <img src="{{asset('public/UserPanel/imgs/blog/blog-3.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                            <a href="blog-post-fullwidth.html">
                                                <img src="{{asset('public/UserPanel/imgs/blog/blog-4.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                            <a href="blog-post-fullwidth.html">
                                                <img src="{{asset('public/UserPanel/imgs/blog/blog-5.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                                    ...
                                    <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                        <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                            <a href="blog-post-fullwidth.html">
                                                <img src="{{asset('public/UserPanel/imgs/blog/blog-6.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                            ...
                            <!--<div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none animated">
                                <img src="{{asset('public/UserPanel/imgs/banner/banner-11.jpg')}}" alt="">
